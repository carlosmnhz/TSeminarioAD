...
if ($_SESSION['escritorio']==1)
{
  ...
  //sufijo c identificamos las compras
  $rsptac = $consulta->totalcomprahoy();
  $regc=$rsptac->fetch_object();
  $totalc=$regc->total_compra;
  //ventas
  $rsptav = $consulta->totalventahoy();
  $regv=$rsptav->fetch_object(); //fetch_object obtiene todos los datos de vuelta
              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Dashborad de compras y ventas </h1>
